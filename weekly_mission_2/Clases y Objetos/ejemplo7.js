...
class MissionCommander {
  ...
  console.log(missionCommanderNode.getStudents) // 100 por default ya que ariba se añadio nuevo valor
  console.log(missionCommanderNode.getLives)// 3 por default  ya que arria se añadio nuevo valor